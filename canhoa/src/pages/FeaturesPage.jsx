    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg-secondary)' }}>
      ...
      <div className="container section-sm" style={{ textAlign: 'center' }}>
        ...
        <div className="grid-3" style={{ marginBottom: 48 }}>
          {[
            { name: 'Starter', price: 49, units: 'Up to 50 units', color: '#22c55e', features: ['All core features', 'Automated payments (ACH + card)', 'Email + SMS communication', 'Violation tracking', 'Document storage (unlimited)', 'Resident portal', 'Mobile app access', 'Email support'] },
            { name: 'Growth', price: 199, units: 'Up to 200 units', color: '#16a34a', featured: true, badge: 'Most Popular', features: ['Everything in Starter', 'Online voting & surveys', 'Amenity booking system', 'USPS physical mailing', 'HOA website builder + AI chatbot', '30+ financial reports', 'Vendor management', 'Onboarding specialist', 'Phone + chat support'] },
            { name: 'Enterprise', price: 349, units: 'Unlimited units', color: '#052e16', features: ['Everything in Growth', 'Unlimited communities', 'REST API access', 'White-label option', 'SAML SSO', 'Custom integrations', 'Dedicated account manager', 'Priority phone support', 'Custom SLA'] },
          ].map(plan => (
            <div key={plan.name} style={{ background: 'var(--bg-card)', border: `2px solid ${plan.featured ? 'var(--accent-primary)' : 'var(--border-color)'}`, borderRadius: 20, padding: 32, position: 'relative', boxShadow: plan.featured ? '0 0 0 4px rgba(22,163,74,0.12)' : 'none' }}>
