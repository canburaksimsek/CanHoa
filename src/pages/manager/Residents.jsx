  ...
  return (
    <div>
      ...
      <div className="grid-4" style={{ marginBottom:24 }}>
        {[
          { label:'Total Residents', value:residents.length, color:'#22c55e', sub:`${residents.filter(r=>r.isOwner).length} owners, ${residents.filter(r=>!r.isOwner).length} tenants` },
          { label:'Current', value:residents.filter(r=>r.status==='current').length, color:'#22c55e', sub:'In good standing' },
...
export function Payments() {
  ...
  return (
    <div>
      ...
      <div className="grid-4" style={{ marginBottom:24 }}>
        {[
          { label:'MTD Collected', value:`$${FINANCIAL_SUMMARY.mtdCollected.toLocaleString()}`, color:'#22c55e', sub:`${FINANCIAL_SUMMARY.collectionRate}% rate` },
