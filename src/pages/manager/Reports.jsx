...
const REPORTS = [
  ...
  { id:'annual', title:'Annual Community Report', desc:'Full-year financial + operational summary — multi-page', icon:Star, color:'#052e16', category:'Executive', hasPDF:true, hasExcel:true, featured:true },
  { id:'all', title:'Full Excel Package', desc:'ALL reports in one workbook — Income, Aging, Budget, Transactions, Residents, Vendors, Violations', icon:Download, color:'#16a34a', category:'Executive', hasPDF:false, hasExcel:true, featured:true },
]
  ...
  return (
    <div>
      ...
      <div className="grid-4" style={{ marginBottom:24 }}>
        {[
          { label:'YTD Collections', value:`$${FINANCIAL_SUMMARY.ytdCollected.toLocaleString()}`, sub:`${FINANCIAL_SUMMARY.collectionRate}% rate`, color:'#16a34a' },
            ...
            <div className="card">
              ...
              <ResponsiveContainer width="100%" height={220}>
                <AreaChart data={MONTHLY_COLLECTIONS} margin={{top:5,right:10,left:0,bottom:0}}>
                  ...
                  <Area type="monotone" dataKey="collected" name="Collected" stroke="#16a34a" strokeWidth={2.5} fill="url(#rg3)" dot={{fill:'#16a34a',r:3}} activeDot={{r:5}}/>
                </AreaChart>
              </ResponsiveContainer>
            </div>
          ...
          <div className="card">
            ...
            <ResponsiveContainer width="100%" height={240}>
              <AreaChart data={MONTHLY_COLLECTIONS} margin={{top:5,right:10,left:0,bottom:0}}>
                ...
                <Area type="monotone" dataKey="collected" name="Collected" stroke="#16a34a" strokeWidth={2.5} fill="url(#rg4)" dot={{fill:'#16a34a',r:3}} activeDot={{r:6}}/>
              </AreaChart>
            </ResponsiveContainer>
          </div>
