    ...
    <div>
      ...
      <div className="card" style={{ marginBottom:24, padding:20 }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fill, minmax(130px,1fr))', gap:10 }}>
          {[
            { label:'Add Charge', icon:CreditCard, color:'#1A365D', to:'/dashboard/payments' },
        ...
        <div className="card">
          ...
          <ResponsiveContainer width="100%" height={210}>
            <AreaChart data={MONTHLY_COLLECTIONS} margin={{top:5,right:10,left:0,bottom:0}}>
              ...
              <Area type="monotone" dataKey="collected" name="Collected" stroke="#1A365D" strokeWidth={2.5} fill="url(#dg1)" dot={{fill:'#1A365D',r:2}} activeDot={{r:5}}/>
            </AreaChart>
          </ResponsiveContainer>
        </div>
