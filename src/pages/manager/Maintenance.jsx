    ...
    <div>
      ...
      <div className="grid-4" style={{ marginBottom:20 }}>
        {[
          ...
          { label:'Resolved 30d', value:requests.filter(r=>r.status==='Resolved').length, color:'#22c55e', sub:'Avg '+Math.round(requests.filter(r=>r.status==='Resolved').length)+'d resolution' },
